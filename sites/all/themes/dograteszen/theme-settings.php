 ...
 */
function dograteszen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['dograteszen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('dograteszen sample setting'),
  '#default_value' => theme_get_setting('dograteszen_example'),
